var homePickerApp = angular.module("homePickerApp", ['ui.bootstrap']);

//homePickerApp.config(function($routeProvider) {
//
//    $routeProvider
//        .when('/home', {
//                controller: 'homePickerCtrl',
//                templateUrl: 'home.html'
//
//            }
//
//    )
//        .when('/startHomePicker', {
//            controller: 'startHomePickerCtrl',
//            templateUrl: 'startHomePicker.html'
//        })
//        .when('/about', {
...
homePickerApp.controller("homePickerCtrl",function ($scope , $http , $location, $anchorScroll) {
...
homePickerApp.directive("modalShow", function () {
    return {
        restrict: "A",
        scope: {
            modalVisible: "="
...
homePickerApp.directive ('carousele', function() { 
    return {
     restrict: 'E',
      transclude: true,
       scope: { id: '@' },
 ...
 homePickerApp.directive('carouseleItem', function() { 
    return { 
          require: '^carousele',
          restrict: 'E',
           transclude: true,
            scope: { },
             link: function(scope, element, attrs, homePickerCtrl) { homePickerCtrl.addItem(scope); },
